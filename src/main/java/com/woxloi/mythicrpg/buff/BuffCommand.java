...
/**
 * /mrpg buff add <player> <type> <magnitude> <seconds>
 * /mrpg buff clear <player>
 * /mrpg buff list <player>
 */
public class BuffCommand {
    ...
    public static boolean execute(CommandSender sender, String[] args) {
        ...
        switch (sub) {
            ...
            case "add" -> {
                if (args.length < 5) {
                    sender.sendMessage("§c使い方: /mrpg buff add <プレイヤー> <タイプ> <倍率> <秒数>");
                    return true;
                }
            ...
            case "clear" -> {
                if (args.length < 2) {
                    sender.sendMessage("§c使い方: /mrpg buff clear <プレイヤー>");
                    return true;
                }
            ...
            case "list" -> {
                if (args.length < 2) {
                    sender.sendMessage("§c使い方: /mrpg buff list <プレイヤー>");
                    return true;
                }
    ...
    // バフ一覧表示
    // =========================
    public static void showList(CommandSender sender, Player target) {
        ...
        for (var buff : buffs) {
            ...
            sender.sendMessage(color + "  ■ "
                    ...
                    + " §7×" + buff.getMagnitude()
                    + " §7残り" + buff.getRemainingSeconds() + "秒");
        }
    }
